<li class="bg-white flex items-center gap-x-3 mt-4 p-4 border-b last:border-none border-gray-400 rounded-lg shadow-md">
    ...
    <div>
        ...
        <span class="inline-flex items-center gap-x-1 text-gray-500 @if ($todo->is_done) text-red-600 @endif">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
            </svg>
            <p>{{ $todo->created_at->format('d M Y H:i') }}</p>
        </span>
    </div>
    ...
    <div class="ml-auto flex items-center gap-x-1">
        ...
        <button type="button" class="px-2 text-red-600 hover:text-red-800"
            onclick="showDeleteModal('{{ route('todo.destroy', ['idTodo' => $todo->id]) }}')">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
